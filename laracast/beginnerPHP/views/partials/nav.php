<?php 
$home = "/phpcourse/laracast/beginnerPHP/";
$about = "/phpcourse/laracast/beginnerPHP/about";
$contact = "/phpcourse/laracast/beginnerPHP/contact";
$notesPage = "/phpcourse/laracast/beginnerPHP/notes";
?>
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            ...
            <img class="h-8 w-8" src="https://kadirguelec.de/assets/png/kg-ico.png" alt="Your Company">
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              <a href="<?= $home?>" class="<?= urlIs($home) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
              ...
              <a href="<?= $notesPage?>" class="<?= urlIs("$notesPage") ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'?> rounded-md px-3 py-2 text-sm font-medium">Notes</a>
